...
\label{subsec:proposal-intro-problem-domain}
...
\label{subsubsec:proposal-intro-question-challenges-for-judges}
...
\label{subsubsec:proposal-intro-question-difficulty-scored}
...
\label{subsubsec:proposal-intro-question-what-are-the-skill}
...
\label{subsec:proposal-intro-solution-domain}
...
\label{subsubsec:proposal-intro-question-integration}
...
\label{subsubsec:proposal-intro-question-data}
...
\label{subsubsec:proposal-intro-question-acceptable-results}
...
\label{subsubsec:proposal-intro-question-hybrid-model-judge-quality}
...
\label{subsubsec:proposal-intro-question-earlier-research-guidance}
...
\label{subsubsec:proposal-intro-question-poc}
...
\label{subsubsec:proposal-intro-question-expected-data-to-increase-accuracy}
...
\label{subsubsec:proposal-intro-question-additional}
...
\label{subsubsec:proposal-intro-summary}
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{img/sr}
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\linewidth]{img/sr-dense}
...
\label{subsec:proposal-skillcomplexiteit}
