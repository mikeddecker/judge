...
\begin{table}[h!]
    ...
    \end{tabular}
    \caption{Crop results manually checked on the amount of seconds where a crop is disturbing. The reason why it is disturbing is added in the reason column, this could be athletes out of view, unstable/earthquake like predictions... \\
...
\subsection{Full video crops - automated testing (Work in Progress)}
