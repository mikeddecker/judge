...
Inspecting these results further, some videos indicate more than -70\% score difference. This indicates invalid crops, potentially because of a different sport gymnasium and a lower camera perspective, compared to other videos.
...
\begin{table}
    \begin{tabular}{|l|l|}
        ...
        8 & 11 \\ \hline
    \end{tabular}
    \caption[level to score map]{Corresponding score for each skill level, in Belgium, levels are limited to 6, any higher level remains a level 6.}
