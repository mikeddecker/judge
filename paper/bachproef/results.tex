...
\begin{figure}
    ...
    \caption[upsampling distribution of skills]{Occurance of upsampeled segmented skills. Unqiue combinations, e.g. a mistake, where the turners turned a triple under with an EB and a front-flip could occure multiple times (e.g. 20 times), as compared to a normal jump, normally turned, re-appearing twice in a training round as normal jumps already has many more labels in the dataset.}
