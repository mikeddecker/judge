<template>
  ...
  @rowExpand="onRowExpand" @rowCollapse="onRowCollapse" tableStyle="min-width: 60rem">
    ...
    <template #footer>
      ...
      <LayerComposition v-if="!new_composition_is_empty" :composition-name="new_composition" @composition-saved="new_composition = null" @moved:layer="refreshLayers"></LayerComposition>
    </template>
  </DataTable>
</template>
