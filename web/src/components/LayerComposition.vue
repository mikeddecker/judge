<template>
    <div v-if="composition">
        ...
        <div class="flex flex-wrap gap-4 mb-4">
            <LayerCompositionElementCard class="w-1/4" title="General" :stage-properties="composition['GeneralProperties']" @update:attribute="(name, attribute, value) => updateLayerCompositionAttributeValue(compositionName, null, name, attribute, value)"></LayerCompositionElementCard>
            <LayerCompositionElementCard class="w-1/4" title="Start" :stage-properties="composition['StartProperties']" @update:attribute="(name, attribute, value) => updateLayerCompositionAttributeValue(compositionName, 0, name, attribute, value)"></LayerCompositionElementCard>
            <LayerCompositionElementCard class="w-1/4" title="End" :stage-properties="composition['EndProperties']" @update:attribute="(name, attribute, value) => updateLayerCompositionAttributeValue(compositionName, -1, name, attribute, value)"></LayerCompositionElementCard>
        </div>
        ...
        <div class="flex flex-wrap gap-4 mb-4">
            <LayerCompositionElementCard 
                ...
                @update:attribute="(name, attribute, value) => updateLayerCompositionAttributeValue(compositionName, Number(stageNr), name, attribute, value)"
